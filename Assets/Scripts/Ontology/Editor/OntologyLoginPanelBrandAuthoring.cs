...
{
    public static class OntologyLoginPanelBrandAuthoring
    {
        private const string RootName = "AccountLoginPanel";

        [MenuItem("Tormia/UI/Apply Editable TOV Login Design")]
        public static void Apply()
        {
            var rootObject = GameObject.Find(RootName);
            if (rootObject == null) throw new InvalidOperationException(RootName + " was not found in the open scene.");
            ...
            Undo.RecordObject(root, "Apply editable TOV login design");
            root.anchorMin = root.anchorMax = root.pivot = new Vector2(0.5f, 0.5f);
            root.anchoredPosition = Vector2.zero;
            root.sizeDelta = new Vector2(860f, 980f);
            ...
            PlaceTop(logo.rectTransform, new Vector2(0f, -5f), new Vector2(680f, 340f));
            ...
            PlaceTop(title.rectTransform, new Vector2(0f, -310f), new Vector2(700f, 105f));
            ...
            PlaceTop(emailLabel.rectTransform, new Vector2(0f, -420f), new Vector2(650f, 32f));
            PlaceTop(passwordLabel.rectTransform, new Vector2(0f, -565f), new Vector2(650f, 32f));
            StyleText(emailLabel, 22f, TextAlignmentOptions.Left, new Color32(22, 53, 72, 255), FontStyles.Bold);
            StyleText(passwordLabel, 22f, TextAlignmentOptions.Left, new Color32(22, 53, 72, 255), FontStyles.Bold);

            var emailInput = StyleInput(root, "EmailInput", new Vector2(0f, -460f), TMP_InputField.ContentType.EmailAddress, flatInput, flatCanvas);
            var passwordInput = StyleInput(root, "PasswordInput", new Vector2(0f, -605f), TMP_InputField.ContentType.Password, flatInput, flatCanvas);
            var loginButton = StyleButton(root, "LoginButton", "LoginButtonSurface", new Vector2(0f, -720f), new Vector2(650f, 78f), true, flatCanvas);
            var createButton = StyleButton(root, "CreateAccountButton", "CreateButtonSurface", new Vector2(0f, -820f), new Vector2(650f, 72f), false, flatCanvas);

            DestroyChild(root, "CustomizeAppearanceButton");
            DestroyChild(root, "DisplayNameInput");
            ...
            var panel = rootObject.GetComponent<OntologyAccountLoginPanel>();
            ...
            SetReference(serializedPanel, "loginButton", loginButton);
            SetReference(serializedPanel, "createAccountButton", createButton);
            ...
            Debug.Log("Applied editable TOV login UI to " + rootObject.scene.path + ".");
        }

        private static TMP_InputField StyleInput(RectTransform root, string name, Vector2 position, TMP_InputField.ContentType contentType, Sprite inputSprite, Sprite fallback)
        {
            var rect = Require<RectTransform>(root, name);
            PlaceTop(rect, position, new Vector2(650f, 72f));
            ...
            StyleText(text, 24f, TextAlignmentOptions.Left, new Color32(22, 53, 72, 255), FontStyles.Normal);
            ...
            StyleText(placeholder, 24f, TextAlignmentOptions.Left, new Color32(80, 101, 112, 125), FontStyles.Normal);
            placeholder.text = name == "EmailInput" ? "name@example.com" : "Enter your password";
