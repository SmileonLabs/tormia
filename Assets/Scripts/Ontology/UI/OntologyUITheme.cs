...
namespace Tormia.Ontology.Core
{
    ...
    public sealed class OntologyUITheme : ScriptableObject
    {
        ...
        public Vector2 actorToastSize = new Vector2(300f, 76f);
        public Vector3 actorToastWorldOffset = new Vector3(0f, 0.45f, 0f);
        public Vector3 actorToastFloatOffset = new Vector3(0f, 0.12f, 0f);
        public float actorToastDuration = 1.35f;
        public float actorToastFadeDuration = 0.35f;
        public float actorToastQueueGap = 0.12f;
        public float actorToastWorldScale = 0.004f;
        public float actorToastReferenceDistance = 8f;
        public float actorToastMinScale = 0.0035f;
        public float actorToastMaxScale = 0.006f;
